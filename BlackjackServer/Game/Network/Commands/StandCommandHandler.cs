...
public class StandCommandHandler : ICommandHandler<StandDTO>
{
    private IHubContext<BlackjackHub> _hubContext;
    private readonly UserManager _userManager;
    private readonly GameRoomManager _gameRoomManager;

    public StandCommandHandler(IHubContext<BlackjackHub> hubContext, UserManager userManager, GameRoomManager gameRoomManager)
    {
    ...
    public async Task HandleAsync(StandDTO command, CommandContext context)
    {
