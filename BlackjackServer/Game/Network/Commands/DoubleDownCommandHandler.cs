...
public class DoubleDownCommandHandler : ICommandHandler<DoubleDownDTO>
{
    private IHubContext<BlackjackHub> _hubContext;
    private readonly UserManager _userManager;
    private readonly GameRoomManager _gameRoomManager;

    public DoubleDownCommandHandler(IHubContext<BlackjackHub> hubContext, UserManager userManager, GameRoomManager gameRoomManager)
    {
    ...
    public async Task HandleAsync(DoubleDownDTO command, CommandContext context)
    {
